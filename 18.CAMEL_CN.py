# 设置OpenAI API密钥
# 需要 OPENAI_API_KEY（花店营销 CAMEL 对话会调用 OpenAI 模型）
import os
...
请使其更具体化。请发挥你的创意和想象力。
请用{word_limit}个或更少的词回复具体的任务。不要添加任何其他内容。"""
...
assistant_agent = CAMELAgent(assistant_sys_msg, ChatOpenAI(
    model_name="deepseek-v4-flash",
    temperature=0.2,
    base_url="https://api.deepseek.com",
    api_key=api_key,
))
user_agent = CAMELAgent(user_sys_msg, ChatOpenAI(
    model_name="deepseek-v4-flash",
    temperature=0.2,
    base_url="https://api.deepseek.com",
    api_key=api_key,
